...
//        mTonal.extractInto(colors, new GradientColors(), darkColors, new GradientColors());
        ...
        result.mainColor = Color.parseColor("#ff0000"); // darkColors.getMainColor();
        result.secondaryColor = Color.parseColor("#00ff00"); // darkColors.getSecondaryColor();
        result.supportsDarkText = false; // darkColors.supportsDarkText();
        if (colors != null) {
