...
public class Workspace extends PagedView<WorkspacePageIndicator>
    ...
    protected void overScroll(int amount) {
        ...
        Log.d(TAG, "overScroll: "+ amount + ";shouldScrollOverlay="+shouldScrollOverlay);
        Log.d(TAG, "overScroll1: " + mLauncherOverlay);
        Log.d(TAG, "overScroll1: " + mScroller.isSpringing());
        Log.d(TAG, "overScroll1: " + mIsRtl);
